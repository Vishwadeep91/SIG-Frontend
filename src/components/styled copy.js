...
export const CustomTimelineDot = styled('div')(({ theme }) => ({
    width: '36px',
    height: '36px',
    borderRadius: '50%',
    ...
    '&:hover': {
        transform: 'scale(1.2)',
        boxShadow: '0 0 0 6px rgba(49, 17, 136, 0.3)',
    },
    '&::before': {
        content: '""',
        position: 'absolute',
...
export const DetailModal = styled(Dialog)(({ theme }) => ({
    '& .MuiDialog-paper': {
        ...
        '&::before': {
            ...
            right: 0,
            height: '200px',
            background: 'linear-gradient(135deg, rgba(49, 17, 136, 0.05) 0%, rgba(34, 197, 94, 0.05) 100%)',
            zIndex: 0,
        },
    },
    '& .MuiDialogTitle-root': {
        background: 'linear-gradient(135deg, #311188 0%, #22c55e 100%)',
        color: 'white',
        padding: theme.spacing(3),
        position: 'relative',
        overflow: 'hidden',
...
export const DetailSection = styled(Box)(({ theme }) => ({
    ...
    '&::before': {
        ...
        width: '200px',
        height: '200px',
        background: 'radial-gradient(circle, rgba(49, 17, 136, 0.05) 0%, rgba(49, 17, 136, 0) 70%)',
        borderRadius: '50%',
        zIndex: 0,
    },
}));
